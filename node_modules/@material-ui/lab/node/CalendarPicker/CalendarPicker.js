...
function getCalendarPickerUtilityClass(slot) {
  return (0, _unstyled.generateUtilityClass)('MuiCalendarPicker', slot);
}

const calendarPickerClasses = (0, _unstyled.generateUtilityClasses)('MuiCalendarPicker', ['root', 'viewTransitionContainer']);
...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)(slots, getCalendarPickerUtilityClass, classes);
};
