...
var appendStyleProps = function appendStyleProps(component, componentsProps, state) {
...
var SwitchUnstyled = /*#__PURE__*/React.forwardRef(function SwitchUnstyled(props, ref) {
  ...
  var rootProps = _extends({}, otherProps, componentsProps.root);

  var Thumb = (_components$Thumb = components.Thumb) != null ? _components$Thumb : 'span';
  var thumbProps = (_componentsProps$thum = componentsProps.thumb) != null ? _componentsProps$thum : {};
  var Input = (_components$Input = components.Input) != null ? _components$Input : 'input';
  var inputProps = (_componentsProps$inpu = componentsProps.input) != null ? _componentsProps$inpu : {};
  var useSwitchProps = {
    checked: checkedProp,
