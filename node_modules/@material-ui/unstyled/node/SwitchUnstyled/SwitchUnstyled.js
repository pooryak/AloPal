...
const appendStyleProps = (component, componentsProps, state) => {
  if (!(0, _utils.isHostComponent)(component)) {
    componentsProps.styleProps = (0, _extends2.default)({}, componentsProps.styleProps, state);
  }
};
/**
...
const SwitchUnstyled = /*#__PURE__*/React.forwardRef(function SwitchUnstyled(props, ref) {
  ...
  const rootProps = (0, _extends2.default)({}, otherProps, componentsProps.root);
